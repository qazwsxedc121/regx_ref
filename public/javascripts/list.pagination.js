...
module.exports = function(options) {
    ...
    var refresh = function() {
        var item,
            ...
            innerWindow = list.innerWindow || 2,
            left = list.left || list.outerWindow || 0,
            right = list.right || list.outerWindow || 0,
            pageClass = list.pageClass || "",
            activeClass = list.activeClass || "active",
            disabledClass = list.disabledClass || "disabled";
